#if UNITY_4_1 || UNITY_4_2 || UNITY_4_3 || UNITY_4_4 || UNITY_4_5 || UNITY_4_6 || UNITY_4_7 || UNITY_5
...
namespace RenderHeads.Media.AVProDeckLink
{
    ...
    public class FormatConverter : System.IDisposable
    {
        ...
        private Material _linearToGammaMat;
        private RenderTexture _linearToGammaTexture;
        ...
        {
            get {
				if (_linearToGammaTexture)
                {
                    return _linearToGammaTexture;
                }
                else
                {
        ...
        public bool Update()
        {
			...
			*/
            ...
            if (_lastFrameUploaded != lastFrameUploaded)
            {
                ...
                if (_linearToGammaMat)
                {
                    Graphics.Blit(_finalTexture, _linearToGammaTexture, _linearToGammaMat);
                }
        ...
        private bool CreateMaterial()
        {
            ...
            {
                Shader lToG = Shader.Find("AVProDeckLink/LinearToGamma");
                _linearToGammaMat = new Material(lToG);
            }
            else
            {
                _linearToGammaMat = null;
            }
        ...
        private void CreateRawTexture()
        {
            ...
            if (_rawTexture == null)    
            {
                ...
                _rawTexture = new Texture2D(textureWidth, textureHeight, TextureFormat.ARGB32, false, linear);
        ...
        private void CreateFinalTexture()
        {
            ...
            if (_linearToGammaMat != null)
            {
                _linearToGammaTexture = RenderTexture.GetTemporary(_mode.Width, _mode.Height, 0, format, RenderTextureReadWrite.Default);
            }
        }
